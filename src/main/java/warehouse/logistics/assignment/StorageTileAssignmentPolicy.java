...
public interface StorageTileAssignmentPolicy<T extends StorageTile> {
    ...
    /**
     * Return whether the given Item can be assigned to a StorageTile in the given Warehouse. Note that this does not
     ...
     * effects.
     *
     * The separation between isAssignable and assign is useful when the assign method mutates the Warehouse.
     ...
     */
    default boolean isAssignable(Item item) {
        return assign(item) != null;
    }
}
